...
public class task1 {
	...
	public void testScenario2() throws InterruptedException {
		...
		todaysDeals.click();
		Thread.sleep(1000);
		// Step 2: Choose "10% off or more" discount filter
		...
		// Step 3: Select "Grocery and Gourmet Food" filter from the left side
		...
		// Step 4: Select the first item in the results
